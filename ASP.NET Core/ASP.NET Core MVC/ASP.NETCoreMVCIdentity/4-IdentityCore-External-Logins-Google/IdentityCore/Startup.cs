        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            */
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("RequireUserNames", policy => policy.Requirements.Add(new RequireUserNames("email@example.com", "e.mail@example.com", "mail@example.com", "admin@example.com", "facebook@example.com", "google@example.com")));
            });
