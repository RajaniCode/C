// static variable in static method // USING CLASS(ES)

// instance variable in static method // USING CLASS(ES)
...
{  //
    static void Main() 
    {
        ...
        Console.WriteLine("The result = {0}", MyClass.myMethod(mc1)); 
        Console.WriteLine("The result = {0}", MyClass.myMethod(mc2));
    }
}
