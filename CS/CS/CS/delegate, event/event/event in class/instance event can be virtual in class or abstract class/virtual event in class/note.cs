...
// #Note: calling base class instance event in a derived class instance method using 'base', and then calling the instance method from Main()
...
{
    static void FurtherDerivedClassHandler()
    {
        Console.WriteLine("Event occurred in FurtherDerivedClass");
    } 
    
    public void methodFurtherDerivedClass()
    {
        base.MyEvent += FurtherDerivedClassHandler; // #Note
        base.Onev();
    }
}
