...
class MyClass
{    
    public int myMethod(double number, out double bp) // *Match: return type, int
    {
       int i;
       i = (int)number;
       bp = number - i;
...
class MainClass
{
    static void Main()
    {
        ...
        double b; // NOTE: Difference between ref and out

        MyClass mc = new MyClass();
        a = mc.myMethod(10.125, out b); // *Match: type of the variable = return type of the method
