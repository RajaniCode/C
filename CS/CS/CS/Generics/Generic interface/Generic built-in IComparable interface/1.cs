// Generic built-in IComparable interface // using generic method
...
class MyClass : IComparable<MyClass> //#Note
{
    int value;
    ...
    public int CompareTo(MyClass ob)  //#Note
    {
...
class MainClass
{
    static bool isIn<T>(T tp, T[] tarrayp) where T : IComparable<T> //#Note
    {
