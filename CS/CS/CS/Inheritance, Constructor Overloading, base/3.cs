// Inheritance - Constructor Overloading // base() // 6, 10
...
{   
    ...
    {
        Console.WriteLine("\nBaseClass constructor invoked: " + s);     
    }

     public BaseClass(int i, int k)
     { 
	 Console.WriteLine("\nBaseClass constructor invoked: " + i);
     }
}
...
class DerivedClass : BaseClass 
{
    ...
    {
        Console.WriteLine("\nDerivedClass constructor invoked: " + s);     
    } 

    public DerivedClass(int i, int j, int k)  : base(i, k) 
    {
	Console.WriteLine("\nDerivedClass constructor invoked: " + i + " and " + j);     
    }   
}
