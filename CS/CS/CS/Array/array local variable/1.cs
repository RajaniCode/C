...
class MainClass
{
    static void Main()
    {
        ...
        int y = 3; int[] a = new int[y]; // POSSIBLE ONLY without assignment  // POSSIBLE ONLY in case of LOCAL (inside static/instance method) AND INSIDE CONSTRUCTOR // array index should be less than y    
