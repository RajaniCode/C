...
namespace LinqOverTypedDataSet
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            samples.DataSetLinq115();   // Simple queries using typed dataset
            //samples.DataSetLinq116();   // Projection using typed dataset
            //samples.DataSetLinq117();   // Load an existing DataTable with query results
        }
