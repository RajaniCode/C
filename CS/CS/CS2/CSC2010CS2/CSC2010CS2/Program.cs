...
*/
#pragma warning disable 0168, 0169, 3021 //3021 for CLSCompliant
[CLSCompliant(false)]
class NullableTypes
{
    //2. Nullable Types 
    //System.Nullable<[ValueType]> or [ValueType]? 
    //Can be member or local variable
    //Defaulted to null as member variable
    //Can be static 
    //warning 0169
    System.Nullable<StuctureType> NullableStucture; //StuctureType is a struct
    bool? NullableBool;
    sbyte? NullableSByte;
    byte? NullableByte;    
    short? NullableShort;
    ushort? NullableUShort;
    int NullableInteger; //System.Nullable<int> NullableInteger;
    uint? NullableUInt;
    long? NullableLong;
    ulong? NullableULong;
    float? NullableFloat;
